...
import { useSocialButtons } from './helper';
import { Row, SocialBtn, Divider, DividerLine, DividerText } from './styled';
...
export function SocialButtons({ onSocial }: SocialButtonsProps) {
  ...
  const { palette, handleGoogle, handleApple } = useSocialButtons(onSocial);
